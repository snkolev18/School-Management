...
namespace UnitTestingQA
{
	...
	public:
		...
		TEST_METHOD(shouldReturnFalseIfTeamNameLengthIsNotCorrect)
		{
			// Arrange
			string teamName = "POGOLQMOOT25KATODULJINADADADADADA";

			// Act
			bool isValid = checkTeamNameLength(teamName);
		...
		TEST_METHOD(shouldReturnTrueIfTeamNameLengthIsCorrect)
		{
			// Arrange
			string teamName = "Offsec";
